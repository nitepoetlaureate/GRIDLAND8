...
LIVECAMS: tuple[LiveCam, ...] = (
    ...
    # ── Greater Philadelphia / PA region (operator-published live streams) ──
    LiveCam("nps_independence_hall", "Independence National Historical Park",
            39.9489, -75.1500,
            "https://www.nps.gov/inde/learn/photosmultimedia/index.htm",
            None, "US National Park Service", "parks"),
    LiveCam("nps_valley_forge", "Valley Forge NHP",
            40.0998, -75.4365,
            "https://www.nps.gov/vafo/learn/photosmultimedia/multimedia.htm",
            None, "US National Park Service", "parks"),
    LiveCam("pgc_hanover_eagle", "PA Game Commission Hanover Bald Eagle Cam",
            39.7898, -76.9839,
            "https://www.pa.gov/agencies/pgc/education/wildlife-live-cameras.html",
            None, "Pennsylvania Game Commission", "nature"),
    LiveCam("pgc_middlecreek_snowgeese", "Middle Creek Snow Geese Migration Cam",
            40.2628, -76.2581,
            "https://www.pa.gov/agencies/pgc/education/wildlife-live-cameras.html",
            None, "Pennsylvania Game Commission", "nature"),
    LiveCam("pgc_elk_cam", "PA Elk Country Live Cam",
            41.4970, -78.2956,
            "https://www.pa.gov/agencies/pgc/education/wildlife-live-cameras.html",
            None, "Pennsylvania Game Commission", "nature"),
    LiveCam("hawkmountain_sanctuary", "Hawk Mountain Sanctuary Raptor Cams",
            40.6300, -75.9886,
            "https://www.hawkmountain.org/visit/raptor-cams",
            None, "Hawk Mountain Sanctuary", "nature"),
    LiveCam("longwood_gardens", "Longwood Gardens",
            39.8702, -75.6750,
            "https://longwoodgardens.org/about/our-organization/operating-status",
            None, "Longwood Gardens", "nature"),
    LiveCam("noaa_cape_may_buoy", "Cape May NOAA Buoy 44091",
            39.7717, -73.7700,
            "https://www.ndbc.noaa.gov/station_page.php?station=44091",
            None, "NOAA NDBC", "weather"),
    LiveCam("noaa_delaware_bay_buoy", "Delaware Bay NOAA Buoy DBLN6",
            38.7833, -75.1167,
            "https://www.ndbc.noaa.gov/station_page.php?station=dbln6",
            None, "NOAA NDBC", "weather"),
)
